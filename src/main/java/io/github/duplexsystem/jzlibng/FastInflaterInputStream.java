 ...
 * @since 1.1
 */
public class FastInflaterInputStream extends FilterInputStream {
    /**
     * Decompressor for this stream.
     */
    protected FastInflater inf;
     ...
     */
    public FastInflaterInputStream(InputStream in, FastInflater inf, int size) {
        super(in);
        if (in == null || inf == null) {
     ...
     * @param inf the decompressor ("inflater")
     */
    public FastInflaterInputStream(InputStream in, FastInflater inf) {
        this(in, inf, 512);
    }
     ...
     * @param in the input stream
     */
    public FastInflaterInputStream(InputStream in) {
        this(in, in != null ? new FastInflater() : null);
