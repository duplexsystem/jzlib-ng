...
Java_io_github_duplexsystem_jzlibng_FastDeflater_init(JNIEnv *env, jclass cls, jint level,
...
Java_io_github_duplexsystem_jzlibng_FastDeflater_setDictionary(JNIEnv *env, jclass cls, jlong addr,
...
JNIEXPORT void JNICALL
Java_io_github_duplexsystem_jzlibng_FastDeflater_setDictionaryBuffer(JNIEnv *env, jclass cls, jlong addr,
...
JNIEXPORT jlong JNICALL
Java_io_github_duplexsystem_jzlibng_FastDeflater_deflateBytesBytes(JNIEnv *env, jobject this, jlong addr,
...
JNIEXPORT jlong JNICALL
Java_io_github_duplexsystem_jzlibng_FastDeflater_deflateBytesBuffer(JNIEnv *env, jobject this, jlong addr,
                                         jbyteArray inputArray, jint inputOff, jint inputLen,
...
JNIEXPORT jlong JNICALL
Java_io_github_duplexsystem_jzlibng_FastDeflater_deflateBufferBytes(JNIEnv *env, jobject this, jlong addr,
...
JNIEXPORT jlong JNICALL
Java_io_github_duplexsystem_jzlibng_FastDeflater_deflateBufferBuffer(JNIEnv *env, jobject this, jlong addr,
                                         jlong inputBuffer, jint inputLen,
                                         jlong outputBuffer, jint outputLen,
                                         jint flush, jint params)
{
...
Java_io_github_duplexsystem_jzlibng_FastDeflater_getAdler(JNIEnv *env, jclass cls, jlong addr)
{
